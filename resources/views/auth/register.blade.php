...
<body>
    <div class="container" >
        <div  class="card m-auto" style="height: 550px; width: 500px; position: relative; top: 100px;">
            <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                ...
                <form method="POST" action="{{ route('register') }}" style="margin-top: 40px; margin-right: 0px;">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <label for="password" class=" col-form-label text-md-end"></label>
